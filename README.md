...
* `street_cleaner`  converts street address attributes to constintent abbreviated or full formats.
* `city_cleaner` converts common city address names to constintent abbreviated or full formats.
